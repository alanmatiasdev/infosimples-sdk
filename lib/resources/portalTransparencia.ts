...
const servidorPublico = async (opts: IConnectOpts, { cpf }: { cpf: string }) =>
  await api.post('/portal-transparencia/servidor', { ...opts, cpf });
...
) => await api.post('/portal-transparencia/ceis', { ...opts, cnpj, cpf });
